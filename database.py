...
columns = {
    ...
    'DurationOfWorstDepression': {('Prefer not to answer'): 0,
                                  ('Less than a month',
    ...
    # Cardiovascular:
    'CardioInsulinMedications': {('Blood pressure medication'): 1,
                        ('Cholesterol lowering medication', 'Insulin',
                         'None of the above', 'Do not know',
                         'Prefer not to answer'): 0},
    'MedsCholesterolHypertensionDiabetes': {['Blood pressure medication']: 1,
                        ['Cholesterol lowering medication', 'Insulin',
    ...
    # ActivityMental:
    'LeisureSocialActivities': {
        ('Prefer not to answer', 'None of the above',
         'Sports club or gym', 'Pub or social club',
         'Religious group',
    ...
    # Stress:
    'IllnessInjuriesStressLast2Years': {('Prefer not to answer'): -1,
                                        ('None of the above'): 0,
                                        (
    ...
    # Diabetes:
    'CardioInsulinMedications': {('Insulin'): 1,
                                 ('Cholesterol lowering medication',
                                  'Blood pressure medication',
                                  'None of the above', 'Do not know',
                                  'Prefer not to answer'): 0},
    'MedsCholesterolHypertensionDiabetes': {['Insulin']: 1,
                            ['Blood pressure medication',
                             'Cholesterol lowering medication',
                             'Hormone replacement therapy',
                             'Oral contraceptive pill or minipill',
    ...
    # Cholesterol:
    'CardioInsulinMedications': {('Cholesterol lowering medication'): 1,
